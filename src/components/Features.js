            ...
            <div className="flex features-column shadow">
              <div style={{ flex: 1 }}>
                <div className="features-title">
                  ...
                  <p className="roboto-condensed">{this.t('networkLayers')}</p>
                </div>
            ...
            <div className="flex features-column shadow">
              <div style={{ flex: 1 }}>
                <div className="features-title">
                  ...
                  <p className="roboto-condensed">{this.t('incentive')}</p>
                </div>
                <p className="features-body raleway">
            ...
            <div className="flex features-column shadow">
              <div style={{ flex: 1 }}>
                <div className="features-title">
                  ...
                  <p className="roboto-condensed">{this.t('zerotime')}</p>
                </div>
                <p className="features-body raleway">
            ...
            <div className="flex features-column shadow">
              <div style={{ flex: 1 }}>
                <div className="features-title">
                  ...
                  <p className="roboto-condensed">{this.t('blending')}</p>
                </div>
                <p className="features-body raleway">
